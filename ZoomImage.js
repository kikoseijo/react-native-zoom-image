...
class ZoomImage extends React.Component<Props, State> {
  static defaultProps = {
    disabled: false,
    startCapture: false,
    moveCapture: false,
  ...
  modalRefBind = this.modalRefBind.bind(this);
  getMaxSizeByRatio = this.getMaxSizeByRatio.bind(this);
  originPosition = {};
  _modal = null;
  ...
  getMaxSizeByRatio(ratio: number) {
    return {
  ...
  modalRefBind(modal: any) {
    this._modal = modal;
  }
  render() {
    return (
      <TouchableWithoutFeedback style={this.props.imgStyle} onPress={this.openModal} ref="view">
        <View style={this.props.style}>
          <Image source={this.props.source} resizeMode={this.props.resizeMode} style={this.props.imgStyle} />
          <ImageModal
...
class ImageModal extends Component {
  ...
  _onMoveShouldSetPanResponder(evt, gestureState) {
    ...
    if (this._inAnimation || this.props.disabled) return;
    if (this.props.responderNegotiate && this.props.responderNegotiate(evt, gestureState) === false)
      return false;
